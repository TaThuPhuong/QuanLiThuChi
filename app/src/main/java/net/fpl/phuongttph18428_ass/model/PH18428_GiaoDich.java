...
public class PH18428_GiaoDich implements Serializable {
    private int maGd;
    ...
    public PH18428_GiaoDich(int maGd, String moTaGd, Date ngayGd, int soTien, int maKhoan) {
        this.maGd = maGd;
        this.moTaGd = moTaGd;
        this.ngayGd = ngayGd;
        this.soTien = soTien;
