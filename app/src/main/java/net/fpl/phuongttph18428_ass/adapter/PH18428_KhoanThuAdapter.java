...
public class PH18428_KhoanThuAdapter extends RecyclerView.Adapter<PH18428_KhoanThuAdapter.ViewHolder> {
    private Context context;
    public  ArrayList<PH18428_GiaoDich> list;
    ...
    public PH18428_KhoanThuAdapter() {
    }

    public PH18428_KhoanThuAdapter(Context context, ArrayList<PH18428_GiaoDich> list, Boolean isDark) {
    ...
    public PH18428_KhoanThuAdapter(Context context, ArrayList<PH18428_GiaoDich> list) {
        this.context = context;
        this.list = list;

    }
    public PH18428_KhoanThuAdapter(Context context, int layout, ArrayList<PH18428_GiaoDich> list) {
        this.context = context;
        this.list = list;
        this.layout=layout;
