...
public class PH18428_LoaiChiAdapter extends RecyclerView.Adapter<PH18428_LoaiChiAdapter.ViewHolder> {
    ...
    public PH18428_LoaiChiAdapter() {
    }

    public PH18428_LoaiChiAdapter(Context context, ArrayList<PH18428_ThuChi> list) {
        this.context = context;
        this.list = list;
    }
    public PH18428_LoaiChiAdapter(Context context, int layout, ArrayList<PH18428_ThuChi> list) {
        this.context = context;
        this.list = list;
        this.layout=layout;
    }
                    ...
                    public void onClick(View v) {
                        ...
                        them.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                PH18428_ThuChi thuchi = new PH18428_ThuChi(tc.getMaKhoan(), themText, 1);
