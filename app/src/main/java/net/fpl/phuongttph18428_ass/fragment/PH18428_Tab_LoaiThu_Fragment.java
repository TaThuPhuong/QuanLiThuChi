...
import net.fpl.phuongttph18428_ass.adapter.PH18428_LoaiThuAdapter;
...
public class PH18428_Tab_LoaiThu_Fragment extends Fragment {
    View view;
    ...
    PH18428_LoaiThuAdapter adapter;
    ...
    public PH18428_Tab_LoaiThu_Fragment() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.ph18428_fragment_tab__loai_thu_, container, false);
        rcv = view.findViewById(R.id.rcv_LoaiThu);
        addBtn = view.findViewById(R.id.addBtn);
        girdBtn = view.findViewById(R.id.girdBtn);
        danhsachBtn = view.findViewById(R.id.danhsachBtn);        PH18428DaoThuChi = new PH18428_DaoThuChi(getActivity());

        list = PH18428DaoThuChi.getThuChi(0);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        rcv.setLayoutManager(layoutManager);
        adapter = new PH18428_LoaiThuAdapter(getActivity(),R.layout.ph18428_oneitem_recylerview, list);
        ...
        girdBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adapter = new PH18428_LoaiThuAdapter(getActivity(),R.layout.ph18428_item_girl, list);
                rcv.setAdapter(adapter);
            }
        });
            ...
            public void onClick(View v) {
                ...
                them.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        PH18428_ThuChi tc = new PH18428_ThuChi(0, themText, 0);
