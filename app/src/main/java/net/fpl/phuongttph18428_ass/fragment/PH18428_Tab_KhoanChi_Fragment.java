...
import net.fpl.phuongttph18428_ass.adapter.PH18428_KhoanChiAdapter;
...
public class PH18428_Tab_KhoanChi_Fragment extends Fragment {
...
View view;
    ...
    PH18428_KhoanChiAdapter adapter;
    ...
    public PH18428_Tab_KhoanChi_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.ph18428_fragment_tab__khoan_chi_, container, false);
        rcv = view.findViewById(R.id.rcv_KhoanChi);
        addBtn = view.findViewById(R.id.addBtn);
        girdBtn = view.findViewById(R.id.girdBtn);
        danhsachBtn = view.findViewById(R.id.danhsachBtn);        PH18428DaoGiaoDich = new PH18428_DaoGiaoDich(getActivity());

        list = PH18428DaoGiaoDich.getGDtheoTC(1);

        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        rcv.setLayoutManager(layoutManager);
         adapter = new PH18428_KhoanChiAdapter(getActivity(),R.layout.ph18428_oneitem_recylerview, list);
        ...
        girdBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adapter = new PH18428_KhoanChiAdapter(getActivity(),R.layout.ph18428_item_girl, list);
                rcv.setAdapter(adapter);
            }
        });
